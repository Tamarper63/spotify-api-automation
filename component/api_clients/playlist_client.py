...
class PlaylistClient:
    ...
    def get_playlist(self, playlist_id: str, market: Optional[str] = None,
                     additional_fields: Optional[str] = None) -> requests.Response:
        """
        Sends request to retrieve playlist details.
        """
        ...
        if additional_fields:
            params["fields"] = additional_fields
