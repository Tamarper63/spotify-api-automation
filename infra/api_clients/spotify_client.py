...
class SpotifyClient:
    ...
    def get_token_response(self, raw: bool = False):
        ...
        response = _send_request(
            url=self.token_url, method="POST", headers=headers, data=data
        )
    ...
    def create_playlist(
        self, user_id: str, name: str, public=True, collaborative=False, description=""
    ):
        payload = {
            "name": name,
            "public": public,
    ...
    def get_playlist(
        self, playlist_id: str, market=None, fields=None, additional_types=None
    ):
        params = {
            "market": market,
            "fields": fields,
    ...
    def get_playlist_items(
        self, playlist_id: str, market=None, fields=None, limit=None, offset=None
    ):
    ...
    def get_featured_playlists(
        self, country=None, locale=None, timestamp=None, limit=None, offset=None
    ):
        params = {
            "country": country,
            "locale": locale,
