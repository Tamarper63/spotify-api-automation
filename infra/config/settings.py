...
class Settings(BaseSettings):
    ...
    default_playlist_id: str = Field(default="7yyTti5oj0AYY68Zlocb1z", validation_alias="DEFAULT_PLAYLIST_ID")
    spotify_refresh_token: str = Field(validation_alias="SPOTIFY_REFRESH_TOKEN")
    spotify_user_access_token: str = Field(default="", validation_alias="SPOTIFY_USER_ACCESS_TOKEN")
    spotify_user_expires_at: str = Field(default="0", validation_alias="SPOTIFY_USER_EXPIRES_AT")
