...
def test_create_playlist_should_return_201(user_api_clients):
    ...
    response = user_api_clients.spotify.create_playlist(user_id, playlist_name)
...
def test_create_playlist_optional_fields(user_api_clients, public, collaborative):
    ...
    response = user_api_clients.spotify.create_playlist(
...
def test_create_playlist_missing_name(user_api_clients):
    user_id = user_api_clients.spotify.get_current_user_profile().json()["id"]
    response = user_api_clients.spotify.create_playlist(user_id, name=None)
