...
def test_create_playlist_long_description_should_return_400(spotify_user_client):
    ...
    assert_error_response(response, expected_status_codes=400, expected_message_substring="description")
...
@pytest.mark.negative
def test_create_playlist_invalid_token_should_return_400(unauthenticated_playlist_client):
