...
def test_follow_playlist_ok(user_api_clients, default_playlist_id, public):
    response = user_api_clients.spotify.follow_playlist(default_playlist_id, public=public)
...
def test_unfollow_playlist_ok(user_api_clients, default_playlist_id):
    response = user_api_clients.spotify.unfollow_playlist(default_playlist_id)
    assert_status_code_ok(response, 200)
...
def test_follow_playlist_invalid_id(user_api_clients):
    response = user_api_clients.spotify.follow_playlist("invalid123", public=True)
