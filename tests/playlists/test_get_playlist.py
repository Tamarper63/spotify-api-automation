...
def test_get_playlist_with_invalid_id_should_return_400(api_clients, invalid_id):
    ...
    assert_error_response(response, expected_status=400, expected_message_substring="Invalid base62 id")
...
def test_get_playlist_without_auth_should_return_401():
    ...
    assert_error_response(response, expected_status=401, expected_message_substring="access token")
...
def test_get_playlist_with_invalid_market(api_clients, default_playlist_id):
    ...
    assert_error_response(response, expected_status=502)
