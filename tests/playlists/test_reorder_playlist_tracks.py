...
def test_reorder_tracks_with_invalid_range_should_return_400(spotify_user_client, reorder_ready_playlist):
    """
...
@pytest.mark.negative
def test_reorder_tracks_without_auth_should_return_400_or_401(unauthenticated_playlist_client, reorder_ready_playlist):
    """
